...
Puedes consultar toda la documentación en la [wiki](https://github.com/Gozaita/MainuAPI/wiki) de este repositorio. Si decubres cualquier error en la API, puedes notificarlo [aquí](https://github.com/Gozaita/MainuAPI/issues/).
